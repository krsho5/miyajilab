...
int main(){
	...
	CC1 = GetCC();
	for(int i = 0; i < N; ++i){
		FLT(result, test_num[i], p, P_256_LOOPS_FLT);
	}
	...
	CC1 = GetCC();
	for(int i = 0; i < N; ++i){
		FCTMI(result, test_num[i], p, pre_fctmi, P_256_LOOPS_FCTMI);
	}
	//gettimeofday(&end, NULL);
    	//sec = end.tv_sec-start.tv_sec;
    	//usec = end.tv_usec-start.tv_usec;
	...
	CC1 = GetCC();
	for(int i = 0; i < N; ++i){
		hdFCTMI(result, test_num[i], p, pre_hdfctmi, P_256_LOOPS_hdFCTMI);
	}
	//gettimeofday(&end, NULL);
    	//sec = end.tv_sec-start.tv_sec;
    	//usec = end.tv_usec-start.tv_usec;
	...
	CC1 = GetCC();
	for(int i = 0; i < N; ++i){
		ECTMI2(result, test_num[i], p, pre_ectmi, P_256_LOOPS_ECTMI);
	}
	//gettimeofday(&end, NULL);
    	//sec = end.tv_sec-start.tv_sec;
    	//usec = end.tv_usec-start.tv_usec;
	...
	CC1 = GetCC();
	for(int i = 0; i < N; ++i){
		ECTMI3(&result, test_num[i], p, pre_ectmi, P_256_LOOPS_ECTMI);
	}
	//gettimeofday(&end, NULL);
    	//sec = end.tv_sec-start.tv_sec;
    	//usec = end.tv_usec-start.tv_usec;
